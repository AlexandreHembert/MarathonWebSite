 ...
 */
final class Version20181221110303 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', password VARCHAR(255) NOT NULL, photo VARCHAR(256) DEFAULT NULL, nom VARCHAR(45) NOT NULL, prenom VARCHAR(45) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE avis (id INT AUTO_INCREMENT NOT NULL, histoires_id INT DEFAULT NULL, user_id INT DEFAULT NULL, positif TINYINT(1) NOT NULL, INDEX IDX_8F91ABF02E7424E0 (histoires_id), INDEX IDX_8F91ABF0A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE avis ADD CONSTRAINT FK_8F91ABF02E7424E0 FOREIGN KEY (histoires_id) REFERENCES histoire (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE avis DROP FOREIGN KEY FK_8F91ABF02E7424E0');
